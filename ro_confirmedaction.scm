...
(define (ivueparser:parsePollMdibDataReply buf)
  (let ((poll_number (u8data-u16 (subu8data buf 0 2)))
        (rel_time_stamp (ivueparser:parseRelativeTimeStamp (subu8data buf 2 6)))
        ;;(abs_time_stamp (ivueparser:parseAbsoluteTimeStamp "poll_data_result_timestamp" (subu8data buf 6 14)))
...
(define (ivueparser:parsePollMdibDataReplyExt buf)
  (let ((poll_number (u8data-u16 (subu8data buf 0 2)))
        ...
        (rel_time_stamp (ivueparser:parseRelativeTimeStamp (subu8data buf 4 8)))
        ;;(abs_time_stamp (ivueparser:parseAbsoluteTimeStamp "poll_data_result_timestamp" (subu8data buf 8 16)))
